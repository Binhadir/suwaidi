...
class Instructor(object):
    ...
    def run_tradition(self):
        opt.output_dir  = '../best_checkpoints/semeval-zero-shot/fm'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='fm', type=str,required=False)
    ...
    parser.add_argument('--l2reg', default=5e-5, type=float,required=False)
    ...
    parser.add_argument('--stance_loss_weight',default=0.75,type=float,required=False)
    parser.add_argument('--prototype_loss_weight',default=0.075,type=float,required=False)
    ...
    parser.add_argument('--seed', default=100, type=int, help='set seed for reproducibility')
