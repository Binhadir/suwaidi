...
class Instructor(object):
    ...
    def run_tradition(self):
        ...
        # opt.output_dir = 'test_outputs/bert-cross-topic/fm_la/2022-11-21 11-43-27'
        opt.output_dir = '../best_checkpoints/semeval-cross-target/fm_la'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--seed', default=228, type=int, help='set seed for reproducibility')
