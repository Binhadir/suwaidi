...
class Instructor(object):
    ...
    def run_tradition(self):
        ...
        opt.output_dir = '../best_checkpoints/wtwt-zero-shot/ANTM_CI'
    ...
    def test_tradition(self):
        ...
        # print("Test Acc: {} F1_ma:{}".format(acc, f1))
        self.model.train()
        return acc,f1,report,f1_ma
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='ANTM_CI', type=str,required=False)
